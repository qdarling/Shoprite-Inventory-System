...
namespace InventoryManagementSystem
{
    ...
    {
        SqlConnection con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\user\Desktop\L300 2ND SEM 📚\DCIT 318\UI 1\InventoryManagementSystem\InventoryManagementSystem\dbms.mdf;Integrated Security=True;Connect Timeout=30");
